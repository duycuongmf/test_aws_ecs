...
import { Prisma, sCatair } from '@prisma/client';
import {
  PaginationInterface,
  RepositoryInterface,
...
@Injectable()
export class CatairPrismaRepository implements RepositoryInterface<sCatair> {
  constructor(
    private prisma: PrismaService,
    private generatorHelper: GeneratorHelper
  ) {}

  instance(): Prisma.sCatairDelegate<
    'rejectOnNotFound' extends keyof Prisma.PrismaClientOptions
      ? Prisma.PrismaClientOptions['rejectOnNotFound']
      : false
  > {
    try {
      return this.prisma.sCatair;
    } catch (err) {
      throw err;
    }
  }

  async count(countCondition: Prisma.sCatairCountArgs): Promise<any> {
    try {
      return this.prisma.sCatair.count(countCondition);
    } catch (err) {
      throw err;
    }
  }

  async all(select: Prisma.sCatairSelect): Promise<any> {
    try {
      return this.prisma.sCatair.findMany({
        select,
      });
    } catch (err) {
      throw err;
  ...
  async first(id: string | bigint): Promise<sCatair> {
    try {
      if (typeof id === 'string') id = BigInt(id);
      return this.prisma.sCatair.findFirst({ where: { id } });
    } catch (err) {
      throw err;
    }
  }
  ...
  async paginate(params: {
    skip?: number;
    take?: number;
    select?: Prisma.sCatairSelect;
    where?: Prisma.sCatairWhereInput;
  }): Promise<any> {
    try {
  ...
  async search(params: {
    ...
    try {
      ...
      const [total, data] = await Promise.all([
        ...
        this.prisma.sCatair.findMany(queryObject),
      ]);
  ...
  async create(data: Prisma.sCatairCreateInput): Promise<sCatair> {
    try {
      return await this.prisma.sCatair.create({
        data: data,
      });
    } catch (err) {
      throw err;
  ...
  async createMany(
    data: Prisma.sCatairCreateManyInput
  ): Promise<Prisma.BatchPayload> {
    try {
      return await this.prisma.sCatair.createMany({
        data: data,
      });
    } catch (err) {
      throw err;
  ...
  async update(
    include: Prisma.sCatairInclude,
    where: Prisma.sCatairWhereUniqueInput,
    data: Prisma.sCatairUpdateInput
  ): Promise<any> {
    try {
      return await this.prisma.sCatair.update({
        where,
        data,
        include,
      });
  ...
  async updateMany(
    ...
    try {
      return await this.prisma.sCatair.updateMany({
        where,
        data,
      });
    } catch (err) {
  ...
  async delete(where: Prisma.sCatairWhereUniqueInput): Promise<sCatair> {
    try {
      return await this.prisma.sCatair.delete({
        where,
      });
    } catch (err) {
      throw err;
  ...
  async deleteMany(
    ...
    try {
      return await this.prisma.sCatair.deleteMany({
        where,
      });
    } catch (err) {
      throw err;
