...
import { Prisma, sProductForm } from '@prisma/client';
import {
  PaginationInterface,
  RepositoryInterface,
...
@Injectable()
export class ProductFormPrismaRepository
  implements RepositoryInterface<sProductForm>
{
  constructor(
  ...
  instance(): Prisma.sProductFormDelegate<
    'rejectOnNotFound' extends keyof Prisma.PrismaClientOptions
      ? Prisma.PrismaClientOptions['rejectOnNotFound']
      : false
  > {
    try {
      return this.prisma.sProductForm;
    } catch (err) {
      throw err;
    }
  }

  async count(countCondition: Prisma.sProductFormCountArgs): Promise<any> {
    try {
      return this.prisma.sProductForm.count(countCondition);
    } catch (err) {
      throw err;
    }
  }

  async all(select: Prisma.sProductFormSelect): Promise<any> {
    try {
      return this.prisma.sProductForm.findMany({
        select,
      });
    } catch (err) {
      throw err;
  ...
  async first(id: string | bigint, options?: object): Promise<sProductForm> {
    try {
      if (typeof id === 'string') id = BigInt(id);
      return this.prisma.sProductForm.findFirst({ where: { id }, ...options });
    } catch (err) {
      throw err;
    }
  }
  ...
  async paginate(params: {
    skip?: number;
    take?: number;
    select?: Prisma.sProductFormSelect;
    where?: Prisma.sProductFormWhereInput;
    include?: Prisma.sProductFormInclude;
  }): Promise<any> {
    try {
      ...
      const [total, data] = await Promise.all([
        ...
        this.prisma.sProductForm.findMany(query),
      ]);
  ...
  async search(params: {
    ...
    try {
      ...
      const [total, data] = await Promise.all([
        ...
        this.prisma.sProductForm.findMany(queryObject),
      ]);
  ...
  async create(data: Prisma.sProductFormCreateInput): Promise<sProductForm> {
    try {
      return await this.prisma.sProductForm.create({
        data: data,
      });
    } catch (err) {
      throw err;
  ...
  async createMany(
    data: Prisma.sProductFormCreateManyInput
  ): Promise<Prisma.BatchPayload> {
    try {
      return await this.prisma.sProductForm.createMany({
        data: data,
      });
    } catch (err) {
      throw err;
  ...
  async update(
    include: Prisma.sProductFormInclude,
    where: Prisma.sProductFormWhereUniqueInput,
    data: Prisma.sProductFormUpdateInput
  ): Promise<any> {
    try {
      return await this.prisma.sProductForm.update({
        where,
        data,
        include,
      });
  ...
  async updateMany(
    ...
    try {
      return await this.prisma.sProductForm.updateMany({
        where,
        data,
      });
    } catch (err) {
  ...
  async delete(
    where: Prisma.sProductFormWhereUniqueInput
  ): Promise<sProductForm> {
    try {
      return await this.prisma.sProductForm.delete({
        where,
      });
    } catch (err) {
      throw err;
  ...
  async deleteMany(
    ...
    try {
      return await this.prisma.sProductForm.deleteMany({
        where,
      });
    } catch (err) {
      throw err;
